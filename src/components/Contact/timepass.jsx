...
function Contactform() {
  ...
  return (
    ...
    >
      ...
      <div id="conactform" className="  ">
        <div
          className="xl:w-[900px] bg-red-300 w-[530px] md:w-[550px] 
     ...
     xl:space-y-5  xl:h-[130vh]"
        ...
        <div
          id="second"
          className=" bg-[#d6d6d0] w-[530px] mt-[240px]  h-[10vh] xl:w-[620px] md:h-[130vh]  xl:h-[130vh] md:w-[350px] md:pt-10 md:ml-[300px] xl:col-span-1 xl:ml-32"
          style={{
            backgroundImage: `url(${heroSVG})`,
            backgroundSize: "cover",
          }}
        >
          <div
            id="info"
            className=" md:w-[330px] md:-ml-10 w-[650px] lin
         pt-[40px]  p-5 -mt-[420px] xl:-mt-20 md:pt-[350px]
         xl:ml-20 xl:pt-[220px] font-helvetica "
          >
            <h3 className="  text-[35px] xl:text-[45px]  mt-[20px] xl:-mt-20 font-semibold font-helvetica  border-b-2 border-black text-black w-[320px]">
              Contact details
            </h3>

          <div id="div" className="flex justify-between md:flex md:flex-col">
