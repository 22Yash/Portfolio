...
function Contactform() {
  ...
  return (
    <div id="Contact" className="w-[500px] xl:w-full  ">
      <div
        id="contactHeading"
        className="bg-[#d6d6d0]  w-[500px] xl:w-full  border-b-2 border-[#3a3733] "
        style={{ backgroundImage: `url(${heroSVG})`, backgroundSize: "cover" }}
      >
        <h1 className="xl:text-[85px] text-[40px] ml-20 font-helvetica  xl:flex xl:justify-center font-semibold xl:ml-20 xl:pt-5 xl:mt-0 mt-0 pt-10 ">
          Let's work together.{" "}
        </h1>
      </div>
      <div id="conactform" className="xl:grid xl:grid-cols-2 xl:gap-4  ">
        <div
          className="xl:w-[900px] bg-[#d6d6d0] w-[500px] sm:w-[900px] pt-10 text-[#3a3733] h-[200vh]
     ...
     xl:space-y-5  xl:h-[150vh]"
        ...
        <div
          id="second"
          className=" bg-[#d6d6d0] w-[500px] xl:w-[620px]  xl:col-span-1 xl:ml-32"
          style={{
            backgroundImage: `url(${heroSVG})`,
            backgroundSize: "cover",
          }}
        >
          <div
            id="info"
            className=" 
         pt-16 ml-10 p-5 -mt-64 xl:-mt-20
