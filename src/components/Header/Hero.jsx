...
>
       ...
       <section className="zoom">
        ...
        >
          ...
          mt-16 text-[30px] w-full ml-10 md:mt-10  xl:mt-[50px] selection:bg-[#FFD500] selection:text-[#000]
        ...
        <button className="bg-[#b6daed] p-[9px] rounded-full text-[20px] text-black mt-[10px] -ml-[90px]">
