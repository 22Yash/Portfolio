...
<div
      id="hero"
      className="main  w-[700px]  xl:w-full md:w-full sticky h-[115vh]  bg-[#d6d6d0] z-1
      "
       ...
       <section className="zoom">
        ...
        >
          <h1
            ref={heroHeadingRef}
            className="hero 
          text-7xl font-bold  text-center -pt-[10px]   selection:bg-[#6c665e] selection:text-[#3d3a36]
        ...
        <div id="heroRole" className="hero xl:tracking-wide text-[#3b3834]">
          <h1
            className="
          text-7xl font-bold  text-center font-helvetica -pt-[10px] flex flex-col selection:bg-[#6c665e] selection:text-[#3d3a36]
          ...
          >
            <div className="flex  flex-col xl:flex  xl:flex-row xl:gap-10 xl:w-3/4">
              <div ref={roleHeadingOneRef} className="h1 mt-[40px] xl:mt-3 selection:bg-[#6c665e] selection:text-[#3d3a36]">
                Creative
              </div>
              <div ref={roleHeadingOnePartRef} className="h1 -pt-[10px] xl:mt-4 selection:bg-[#6c665e] selection:text-[#3d3a36]">
                Frontend
              </div>
            </div>
            <div
              ref={roleHeadingTwoRef}
              className="h1 -pt-[10px] ml-4 md:ml-5 md:-mt-2 xl:-ml-2 selection:bg-[#6c665e] selection:text-[#3d3a36]"
            >
              Developer.
            </div>
          </h1>
